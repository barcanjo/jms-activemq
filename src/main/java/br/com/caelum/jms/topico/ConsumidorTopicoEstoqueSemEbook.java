...
/**
 * Cria um consumir com assinatura durável com Selector.
 * O Selector será responsável por identificar um cabeçalho da mensagem
 * e utilizá-lo para criar um critério de recebimento da mensagem.
 * Neste caso, este consumer recebe apenas mensagens onde o cabeçalho
 * possui a propriedade ebook com o valor true.
 ...
 *
 */
public class ConsumidorTopicoEstoqueSemEbook {
    ...
    public static void main(String[] args) throws NamingException, JMSException {
        ...
        /*
            ...
            e com a propriedade ebook = false presente no cabeçalho, ou
            se ela não estiver presente no cabeçalho.
         */
