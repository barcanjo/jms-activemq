...
import br.com.caelum.jms.listener.ObjectMessageListenerImpl;
 ...
 *
 */
public class ConsumidorTopicoEstoqueComObjeto {
    ...
    public static void main(String[] args) throws NamingException, JMSException {
        ...
        ObjectMessageListenerImpl messageListenerImpl = new ObjectMessageListenerImpl();
